...
final class MinimumLengthValidator extends AbstractValidator implements FormValidatorInterface
{
    public function __construct(Throwable $error, private int $minimumLength)
    {
